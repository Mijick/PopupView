...
public extension Popup {
    ...
    func dismissAfter(_ seconds: Double) -> some Popup { eraseObject { $0.dismissTimer = DispatchSource.createAction(deadline: seconds) { PopupManager.getInstance().performOperation(.remove(id)) } }}
